...
namespace UnitTests.Yaml
{
	public class YamlParserTest
	{
		...
		[InlineData("{{a: b},{c: d},{e: f}}", 2, 0)]
		[InlineData("a: {{b: c},{d: e},{f: g}}", 2, 0)]
		public async Task CorrectTokens_ShouldWorkProperly(string value, int expectedNumberOfFlowEntriesBefore, int expectedNumberOfFlowEntries)
		{
			var tokens = ParseToTokens(value);
			Assert.Equal(expectedNumberOfFlowEntriesBefore, tokens.Count(token => token is FlowEntry));

			await new YamlParser().CorrectTokens(tokens);
			Assert.Equal(expectedNumberOfFlowEntries, tokens.Count(token => token is FlowEntry));
		}
		...
		/// </summary>
		[Theory]
		[InlineData("firstProperty: \"First value\"", 1, 1)]
		[InlineData("firstProperty: \"First value\"\nsecondProperty: \"Second value\"\nthirdProperty: \"Third value\"", 3, 1)]
		[InlineData("---\nfirstRootProperty:\n  firstSubProperty: \"First sub value\"\n---\nsecondRootProperty:\n  firstSubProperty: \"First sub value\"\n---\nthirdRootProperty:\n  firstSubProperty: \"First sub value\"", 6, 3)]
		[InlineData("---\nfirstRootProperty:\n  firstSubProperty: \"First sub value\"\n---\nsecondRootProperty:\n  firstSubProperty: \"First sub value\"\n---\nthirdRootProperty:\n  firstSubProperty: \"First sub value\"\n...", 6, 3)]
		[InlineData("---\nfirstRootProperty:\n  firstSubProperty: \"First sub value\"\n---\nsecondRootProperty:\n  firstSubProperty: \"First sub value\"\n---\nthirdRootProperty:\n  firstSubProperty: \"First sub value\"\n...\n...", 6, 4)]
		[InlineData("---\nfirstRootProperty:\n  firstSubProperty: \"First sub value\"\n---\nsecondRootProperty:\n  firstSubProperty: \"First sub value\"\n---\nthirdRootProperty:\n  firstSubProperty: \"First sub value\"\n...\n...\n...\n...\n...\n... # Comment 1\n... # Comment 2\n---\n--- # Comment 3\n...", 6, 11)]
		...
		[InlineData("{{a: b},{c: d},{e: f}}", 2, 0)]
		[InlineData("a: {{b: c},{d: e},{f: g}}", 2, 0)]
		public async Task RemoveInvalidFlowEntries_ShouldWorkProperly(string value, int expectedNumberOfFlowEntriesBefore, int expectedNumberOfFlowEntries)
		{
			var tokens = ParseToTokens(value);
			Assert.Equal(expectedNumberOfFlowEntriesBefore, tokens.Count(token => token is FlowEntry));

			await new YamlParser().RemoveInvalidFlowEntries(tokens);
